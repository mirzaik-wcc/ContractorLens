...
FROM Items WHERE csi_code = '09 29 00' AND item_type = 'material' LIMIT 1;
...
FROM Items WHERE csi_code = '09 91 23' AND item_type = 'material' LIMIT 1;
...
FROM Items WHERE csi_code = '09 30 13' AND item_type = 'material' LIMIT 1;
